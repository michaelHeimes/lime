		...
		<div class="grid-x grid-padding-x">
			<div class="cell small-12 large-10 large-offset-1">
				...
				<?php if( $link ): 
					...
					?>
				<div class="link-wrap">
					<a class="button arrow-link bg-teal" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
					<span><?php echo esc_html( $link_title ); ?></span>
					<span class="bg-lime-green grid-x align-middle align-center">

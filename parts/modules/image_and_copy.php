...
?>
<section class="module image-copy bg-forest-green">
	<div class="grid-container">
		<div class="grid-x grid-padding-x tablet-flex-dir-row-reverse align-top">
			<div class="left cell small-12 tablet-7 large-7">
				<?php echo $copy;?>
			</div>
			<div class="right cell small-12 tablet-5 large-5">
				<div class="inner">
					<?php 
					if(!empty( $image ) ): ?>
					...
					if( $link ): 
						...
						?>
						<a class="position-<?php echo $link_position;?> bg-lime-green round-link grid-x flex-dir-column align-center align-middle text-center" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
